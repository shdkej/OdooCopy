...
var KanbanColumn = Widget.extend({
    ...
    events: {
        ...
        'click .o_column_add_already': 'add_already',
    ...
    add_already: function() {
        var self = this;
//        var dataset = new data.Dataset(this, "project.task", self.context);
        this.dataset.name_search('project.task', "", 'ilike', 160).done(function(_data) {
